			...
			<S.AboutMeMainInfo>
				...
				<S.AboutMeTextContainer>
					...
					<S.AboutMeParagraph>
						...
						años de experiencia en el sector retail. Decidí volver a mis
						orígenes de ingeniera y dar un giro de 180 grados, buscando un reto
						profesional motivador y dinámico a través del bootcamp de desarrollo
						full stack web de Keepcoding. Soy una desarrolladora en progreso,
						amante de la tecnología y de aprender cada día más sobre el mundo
						digital.
					</S.AboutMeParagraph>
					<S.AboutMeSkills>
